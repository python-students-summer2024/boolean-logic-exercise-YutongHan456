...
def is_sweltering():
    ...
    temperature = int(input("Please enter the current temperature in Farenheit to see if its sweltering"))
    if temperature > 90:
        return True
    else:
        return False
...
def is_warm():
    ...
    """
    # write your code for this function below this line.
    temperature_warm = int(input("Please enter the current temperature in Farenheit to see if its warm"))
    if 87 > temperature_warm > 75 :
        return True
    else:
        return False
...
def is_humid():
    ...
    """
    # write your code for this function below this line.
    humid = str(input("Is it humid now?"))
    humid_capital = humid.upper()
    if humid_capital == 'YES':
        return True
    elif humid_capital == 'NO':
        return False
...
def is_inclement():
    ...
    """
    # write your code for this function below this line.
    weather = str(input("what the weather forecast is today?"))
    weather_capital = weather.upper()
    if weather_capital == 'RAIN' or weather_capital == 'SNOW' or weather_capital == 'SLEET':
        return True
    else:
        return False
